...
@group('smoke')
class fuzzer(base_tests.SimpleProtocol):

    def add(self,commande,iteration, xid=None, length=None, version = 4, type = None, bversion="!B", btype="!B", blength="!H", bxid = "!L", data = None):
